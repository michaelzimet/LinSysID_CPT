...
These are specific implemenations of the Event-Based Control code published by Faranak Rajabi here: https://github.com/faranakR/HH-Stochastic-Control and require the functions folder from that repository to be present in the same Matlab folder.

Kuramoto

The folder Kuramoto contains the script and supporting functions to calculate the Kuramoto Order Parameter in Fig 11.
